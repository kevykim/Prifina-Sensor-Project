...
function PuttResult({ navigation }) {
  ...
  return (
    <ScrollView contentContainerStyle={styles.main}>
      ...
      <View style={styles.topButtonContainer}>
        ...
        <TouchableOpacity
          style={{
            backgroundColor: route.name === "puttresult" ? "#2FDA74" : "#D3D3D3",
            ...styles.topButtons,
          }}
        >
          <Text
            style={{
              color: route.name === "puttresult" ? "white" : "black",
      ...
      <Text style={styles.PRHeader}>Putting - 5 feet</Text>
      <View style={styles.PRChart}>
        <LineChart
          data={data}
          areaChart
          curved
