          ...
          >
            <View style={styles.tutCard}>
              ...
              <View style={styles.tutInfoContainer}>
                ...
                <Text style={styles.tutInfoL}>
                  Enhance your putting precision with Sarah Lee's expert tips on
                  green reading and stroke control.
                </Text>
              </View>
            </View>
            ...
            <View style={styles.tutCard}>
              ...
              <View style={styles.tutInfoContainer}>
                ...
                <Text style={styles.tutInfoL}>
                  Master your swing technique and unlock your full potential on
                  the course with insights from Ryan Davis.
                </Text>
              </View>
            </View>
            ...
            <View style={styles.tutCard}>
              ...
              <View style={styles.tutInfoContainer}>
                ...
                <Text style={styles.tutInfoL}>
                  Unlock the secrets to powerful and accurate drives with Maria
                  Rodriguez for maximum and precise distances.
                </Text>
              </View>
            </View>
          </ScrollView>
