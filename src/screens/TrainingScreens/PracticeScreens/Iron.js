    ...
    <ScrollView contentContainerStyle={styles.main}>
      <View style={styles.container}>
        ...
        <View style={styles.topButtonContainer}>
          ...
          <TouchableOpacity
            style={{
              backgroundColor: route.name === "iron" ? "#2FDA74" : "#D3D3D3",
              ...styles.topButtons,
            }}
          >
            <Text
              style={{
                color: route.name === "iron" ? "white" : "black",
        ...
        <Text style={styles.ironHeader}>Iron Shots</Text>
        <Image style={styles.ironImage} source={IronImage} />
        <View>
          <Text style={styles.ironInfo}>
