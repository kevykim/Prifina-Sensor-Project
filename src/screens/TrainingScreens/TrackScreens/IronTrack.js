      ...
      <View style={styles.container}>
        ...
        <View style={styles.topButtonContainer}>
          ...
          <TouchableOpacity
            style={{
              backgroundColor:
                route.name === "irontrack" ? "#2FDA74" : "#D3D3D3",
              ...styles.topButtons,
            }}
          >
            <Text
              style={{
                color: route.name === "irontrack" ? "white" : "black",
        ...
        <Text style={styles.ATHeader}>Iron Shots - 100 feet</Text>
        ...
        <View style={styles.shotContainer}>
          ...
          {secondView && (
            <TouchableOpacity
              onPress={() => navigation.navigate("ironresult")}
