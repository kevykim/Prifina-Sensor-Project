      ...
      <View style={styles.container}>
        ...
        <View style={styles.topButtonContainer}>
          ...
          <TouchableOpacity
            style={{
              backgroundColor:
                route.name === "arctrack" ? "#2FDA74" : "#D3D3D3",
              ...styles.topButtons,
            }}
          >
            <Text
        ...
        <Text style={styles.ATHeader}>Arc Adjustment - 100 feet</Text>
        <Text style={styles.ATInfo}>Tap smartwatch to begin</Text>

        <View style={styles.shotContainer}>
          {shotObj.map((shot) => (
            <View key={shot.id}  style={styles.shotCard}>
              <View style={shot.checked === false && shot.X === false ? styles.newShot : shot.checked === true ? styles.shotGreen : styles.shotGray}>
          ...
          {showView && <View style={styles.shotCard}>
            <TouchableOpacity
          ...
          {secondView && (
            <TouchableOpacity
              onPress={() => navigation.navigate("arcresult")}
