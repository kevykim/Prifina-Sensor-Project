...
function IronResult({ navigation }) {
      ...
      <View style={styles.container}>
        ...
        <View style={styles.topButtonContainer}>
          ...
          <TouchableOpacity
            style={{
              backgroundColor:
                route.name === "ironresult" ? "#2FDA74" : "#D3D3D3",
              ...styles.topButtons,
            }}
          >
            <Text
              style={{
                color: route.name === "ironresult" ? "white" : "black",
        ...
        <Text style={styles.ARHeader}>Iron Shots - 100 feet</Text>
