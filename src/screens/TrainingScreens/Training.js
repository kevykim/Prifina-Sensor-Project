...
import IronImage from '../../assets/Golf/IronImage.jpg'
        ...
        <View style={styles.progressContainer}>
          <View style={styles.progressCards}>
            ...
            <View style={styles.progressCardsTContainer}>
              ...
              <Text style={styles.progressCardsText}>
                Turning your swing angle by focusing on stance, posture, and
                grip techniques
              </Text>
              <TouchableOpacity
                onPress={() => navigation.navigate("arcadjustment")}
                style={styles.progressCardsButton}
              >
          ...
          <View style={styles.progressCards}>
            ...
            <View style={styles.progressCardsTContainer}>
              ...
              <Text style={styles.progressCardsText}>
                Hone in on the slight differences that take your putting from 3
                to 1.
              </Text>
              <TouchableOpacity
          ...
          <View style={styles.progressCards}>
            <Image style={styles.progressImage} source={IronImage} />
            <View style={styles.progressCardsTContainer}>
              <Text style={styles.progressCardsTHeader}>Iron Shots</Text>
              <Text style={styles.progressCardsText}>
                Focus on hitting crisp iron shots with a shallow divot after the
                ball to ensure solid contact.
              </Text>
              <TouchableOpacity
